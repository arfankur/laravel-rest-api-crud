            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="@yield('button-link', '#')" class="d-none d-sm-inline-block btn btn-sm @yield('button-color') shadow-sm"><i
                                class="@yield('button-icon') fa-sm text-white-50"></i> @yield('button-caption')</a>
                    </div>
